...
const handleEditarFactura = async (facturaEditada) => {
  ...
  facturaEditada.status === "Pendiente" ? "P" :
  facturaEditada.status === "Cancelado" ? "C" :
  ...
  try {
    ...
    const mensaje =
      err?.message || "Error inesperado al actualizar la factura.";
    toast.error(mensaje);
                    ...
                    <button
                      ...
                      onClick={() => {
                        const tipoNormalizado =
                          factura.type === "Contado" ? "Co" :
                          factura.type === "Crédito" ? "Cr" :
                          factura.type;
    ...
    <div className="modal-content medium">
      ...
      <div style={{
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setNuevaFactura({ ...nuevaFactura, name: e.target.value })
            }
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setNuevaFactura({ ...nuevaFactura, code: e.target.value })
            }
          />
        </div>
        ...
        <div>
          <p>Monto</p>
            <input
              ...
              onChange={(e) =>
                setNuevaFactura({ ...nuevaFactura, amount: e.target.value })
              }
            />
        </div>
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setNuevaFactura({ ...nuevaFactura, date: e.target.value })
            }
          />
        </div>
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              setNuevaFactura({ ...nuevaFactura, type: e.target.value })
            }
          >
        ...
        {nuevaFactura.type === "Cr" && (
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setNuevaFactura({ ...nuevaFactura, due_date: e.target.value })
              }
            />
          </div>
        )}
      ...
      <div>
        ...
        <textarea
          ...
          onChange={(e) =>
            setNuevaFactura({ ...nuevaFactura, description: e.target.value })
          }
        />
      </div>
    ...
    <div className="modal-content large">
      ...
      >
        ...
        <div>
          ...
          <p>
            {facturaSeleccionada.due_date
              ? facturaSeleccionada.due_date.split("T")[0]
              : "—"}
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p style={{ whiteSpace: "pre-wrap" }}>
            {facturaSeleccionada.description || "—"}
          </p>
        </div>
      </div>
      ...
      >
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFacturaEditando({ ...facturaEditando, name: e.target.value })
            }
          />
        </div>
            <div>
      ...
      <option key={prov.supplier_id} value={prov.supplier_id}>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFacturaEditando({ ...facturaEditando, date: e.target.value })
            }
          />
        </div>
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              setFacturaEditando({ ...facturaEditando, type: e.target.value })
            }
          >
            <option value="Co">Contado</option>
            <option value="Cr">Crédito</option>
