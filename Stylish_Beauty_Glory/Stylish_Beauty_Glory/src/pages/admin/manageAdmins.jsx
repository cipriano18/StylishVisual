...
const handleUpdateAdmin = async (admin_id, updatedData) => {
  ...
  useEffect(() => {
    if (searchId.trim() === "") {
      ...
      setFilteredAdmins(
        admins.filter((a) =>
          a.identity_card.toLowerCase().includes(searchId.toLowerCase())
        )
      );
    }
  }, [searchId, admins]);
      ...
      <div className="modal-overlay">
        <div className="modal-content xlarge">
          ...
          <div style={{
            ...
            <div><strong>ID</strong><p>{selectedAdmin.admin_id}</p></div>
            <div><strong>Cédula</strong><p>{selectedAdmin.identity_card}</p></div>
            <div>
          ...
          <div style={{
            ...
            <div><strong>Especialidad</strong><p>{selectedAdmin.specialty || "—"}</p></div>
            <div><strong>Fecha de ingreso</strong><p>{selectedAdmin.entry_date?.slice(0, 10) || "—"}</p></div>
            <div><strong>Certificaciones</strong><p>{selectedAdmin.certifications|| "—"}</p></div>
            <div><strong>Días laborales</strong><p>{selectedAdmin.working_days || "—"}</p></div>
          </div>
          {/* 📞 Contacto */}
          <div style={{ marginBottom: "1rem", display: "flex", alignItems: "center", gap: "0.5rem" }}>
          ...
          <div style={{
            ...
            <div><strong>Correo electrónico</strong><p>{selectedAdmin.contacts?.find(c => c.contact_type === "EMAIL")?.contact_value || "—"}</p></div>
            <div><strong>Teléfono</strong><p>{selectedAdmin.contacts?.find(c => c.contact_type === "TELEFONO")?.contact_value || "—"}</p></div>
          </div>
          {/* 🔐 Datos de usuario */}
          <div style={{ marginBottom: "1rem", display: "flex", alignItems: "center", gap: "0.5rem" }}>
          ...
          <div style={{
            ...
            <div><strong>Usuario</strong><p>{selectedAdmin.user?.username}</p></div>
            <div><strong>Estado</strong><p>{selectedAdmin.user?.status}</p></div>
            <div>
              <strong>Rol</strong>
              <p>
          ...
          <div className="modal-actions">
            <button className="modal-btn cancel" onClick={closeViewModal}>Cerrar</button>
          </div>
        </div>
      </div>
    )}
    ...
    <div className="modal-content xlarge">
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", color: "#4a2e2e" }}>
            <FaUser />
            <strong>Datos personales</strong>
          </div>
          <div>
            <label>Cédula *</label>
            <input type="text" value={newAdmin.identity_card} onChange={(e) => setNewAdmin({ ...newAdmin, identity_card: e.target.value })} />
          </div>
          <div>
            <label>Nombre *</label>
            <input type="text" value={newAdmin.primary_name} onChange={(e) => setNewAdmin({ ...newAdmin, primary_name: e.target.value })} />
          </div>
          <div>
            <label>Segundo nombre</label>
            <input type="text" value={newAdmin.secondary_name} onChange={(e) => setNewAdmin({ ...newAdmin, secondary_name: e.target.value })} />
          </div>
          <div>
            <label>Primer apellido *</label>
            <input type="text" value={newAdmin.first_surname} onChange={(e) => setNewAdmin({ ...newAdmin, first_surname: e.target.value })} />
          </div>
          <div>
            <label>Segundo apellido *</label>
            <input type="text" value={newAdmin.second_surname} onChange={(e) => setNewAdmin({ ...newAdmin, second_surname: e.target.value })} />
          </div>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          ...
          <div>
            ...
            <input type="text" value={newAdmin.email} onChange={(e) => setNewAdmin({ ...newAdmin, email: e.target.value })} />
          </div>
          <div>
            <label>Teléfono *</label>
            <input type="text" value={newAdmin.phone} onChange={(e) => setNewAdmin({ ...newAdmin, phone: e.target.value })} />
          </div>
        </div>
      ...
      <div className="modal-content xlarge">
        ...
        <div style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            ...
            <div>
              <label>Nombre</label>
              <input type="text" value={editAdmin.primary_name} onChange={(e) => setEditAdmin({ ...editAdmin, primary_name: e.target.value })} />
            </div>
            <div>
              <label>Segundo nombre</label>
              <input type="text" value={editAdmin.secondary_name} onChange={(e) => setEditAdmin({ ...editAdmin, secondary_name: e.target.value })} />
            </div>
            <div>
              <label>Primer apellido</label>
              <input type="text" value={editAdmin.first_surname} onChange={(e) => setEditAdmin({ ...editAdmin, first_surname: e.target.value })} />
            </div>
            <div>
              <label>Segundo apellido</label>
              <input type="text" value={editAdmin.second_surname} onChange={(e) => setEditAdmin({ ...editAdmin, second_surname: e.target.value })} />
            </div>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            ...
            <div>
              <label>Especialidad</label>
              <textarea rows="2" value={editAdmin.specialty} onChange={(e) => setEditAdmin({ ...editAdmin, specialty: e.target.value })} />
            </div>
            <div>
              <label>Certificaciones</label>
              <textarea rows="2" value={editAdmin.certifications} onChange={(e) => setEditAdmin({ ...editAdmin, certifications: e.target.value })} />
            </div>
            <div>
              <label>Días laborales</label>
              <textarea rows="2" value={editAdmin.working_days} onChange={(e) => setEditAdmin({ ...editAdmin, working_days: e.target.value })} />
            </div>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            ...
            <div>
              <label>Correo electrónico</label>
              <input type="text" value={editAdmin.email} onChange={(e) => setEditAdmin({ ...editAdmin, email: e.target.value })} />
            </div>
            <div>
              <label>Teléfono</label>
              <input type="text" value={editAdmin.phone} onChange={(e) => setEditAdmin({ ...editAdmin, phone: e.target.value })} />
            </div>
          </div>
        </div>
